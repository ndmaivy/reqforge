...
from app.modules.needs.router import analytics_router as needs_analytics_router
...
from app.modules.public_feedback.router import project_router as public_form_project_router
from app.modules.public_feedback.router import public_router as public_feedback_router
...
api_router.include_router(public_form_project_router)
api_router.include_router(public_feedback_router)
api_router.include_router(project_feedback_router)
api_router.include_router(feedback_router)
api_router.include_router(project_needs_router)
api_router.include_router(needs_analytics_router)
